...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "9fa7dfcef86dd658567c";
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_concat_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat.js */ \"./node_modules/core-js/modules/es.array.concat.js\");\n/* harmony import */ var core_js_modules_es_array_concat_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat_js__WEBPACK_IMPORTED_MODULE_0__);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  props: [\"user\"],\n  mounted: function mounted() {\n    this.loadBackGround();\n  },\n  methods: {\n    loadBackGround: function loadBackGround() {\n      // Let's define the required varibles such as the number of particles to be created and an array to hold the particles\n      var particleContainer = document.getElementById(\"particles\");\n      var Nparticles = 100;\n      var particles = []; // function to return a random number from a given min and max\n\n      function rand(min, max) {\n        return Math.floor(Math.random() * (max - min)) + min;\n      } // This constructor will generate the required information for each particle and it's html structure to be added to the document\n\n\n      function createParticle(i) {\n        this.id = i;\n        this.width = rand(1, 20) + \"px\";\n        this.height = this.width;\n        this.x = rand(0, 100) + \"%\";\n        this.delay = rand(5, 3000) + \"ms\";\n        this.duration = rand(10, 60) + \"s\";\n        this.html = \"<span style=\\\"width: \".concat(this.width, \";  height: \").concat(this.height, \"; left: \").concat(this.x, \"; animation-delay: \").concat(this.delay, \"; animation-duration: \").concat(this.duration, \";\\\">\");\n      } // Let's loop through till we reach the max number of particles and save them to the array and append them to the document\n\n\n      while (particles.length <= Nparticles) {\n        var Particle = new createParticle(particles.length);\n        particles.push(Particle);\n        particleContainer.innerHTML += Particle.html;\n      }\n\n      function parallax() {\n        var body = document.body,\n            bg = document.getElementById(\"parallax\"),\n            startX = 50,\n            startY = 80,\n            w = document.documentElement.offsetWidth,\n            h = document.documentElement.offsetHeight;\n        body.addEventListener(\"mousemove\", function (evt) {\n          var posX = 40 + evt.clientX / w * 0.4 * startX;\n          var posY = 5 + evt.clientY / h * 0.15 * startY;\n          bg.style.backgroundPosition = posX + \"% \" + posY + \"%\";\n        });\n      }\n\n      parallax(); // Hope you liked it and that has inspired you to create something awesome\n    }\n  }\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader-v16/dist/index.js?!./src/views/MainPage.vue?vue&type=script&lang=js\n");
